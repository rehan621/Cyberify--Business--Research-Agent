...
def web_search_tool(query: str) -> str:
    ...
    try:
        ...
        # Add URLs list at end for easy extraction
...
TOOL_DESCRIPTIONS = {
    "web_search_tool":     "🔍 Web Search — Tavily real-time information",
    "calculator_tool":     "🔢 Calculator — Mathematical & financial computations",
    "file_retrieval_tool": "📂 File Retrieval — Uploaded documents search",
}